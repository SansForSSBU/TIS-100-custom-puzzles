...
function get_description()
	return { "TAKE -1 TERMINATED BINARY STRING FROM IN", "OUTPUT REVERSED -1 TERMINATED STRING TO OUT" }
end
...
function get_layout()
	return { 
		TILE_DAMAGED, 	TILE_COMPUTE, 	TILE_DAMAGED, 	TILE_DAMAGED,
		TILE_DAMAGED, 	TILE_COMPUTE,	TILE_DAMAGED, 	TILE_DAMAGED,
		TILE_DAMAGED, 	TILE_COMPUTE,	TILE_DAMAGED, 	TILE_DAMAGED,
	}
end